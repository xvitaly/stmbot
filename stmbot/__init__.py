...
class STMBot:
        ...
        def handle_msg(message):
            try:
                ...
                msg = self.__msgs['stm_result'] % (chk.nickname, chk.steamid32, chk.steamidv3, chk.vacstatus,
                                                   chk.gamebanstatus, chk.tradestatus, chk.f2pstatus, chk.steamid64,
                                                   chk.permalink, chk.description, chk.sitestatus, chk.srstatus)
    ...
    def __init__(self):
        self.bot = TeleBot(APIKeys['tgkey'])
        self.__tfkey = APIKeys['tfkey']
        self.__msgs = {
