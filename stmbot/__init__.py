...
class STMBot:
    ...
    def __init__(self, tgkey, tfkey):
        ...
        self.__msgs = {
            ...
            'stm_legal': '*Правовая информация*\n\nИспользуя данного бота, вы автоматически соглашаетесь с нижеизложенным:\n1. Вы передаёте владельцу данного бота неэксклюзивное, безотзывное право на использование в любых целях любых сообщений, отправленных вами (физическим или юридическим лицом) данному боту, а также разрешаете передачу их третьим сторонам для анализа и предоставления вам результатов.\n2. Вы обязуетесь не передавать боту никаких сообщений, содержащих персональные данные.\n3. Переданные боту данные могут обрабатываться и сохраняться на серверах третьих сторон. При этом сам бот не сохраняет их.\n4. Для выполнения проверок по чёрным спискам, бот обращается к сервисам третьих сторон: TEAM-FORTRESS.SU и STEAMREP от вашего имени, поэтому вы безоговорочно принимаете условия их использования.',
